...
### branch-pr
- Path: /home/guayaba/.claude/skills/branch-pr/SKILL.md
...
### caveman
- Path: /home/guayaba/.agents/skills/caveman/SKILL.md
- Trigger: >
- Rules:
...
### caveman-commit
- Path: /home/guayaba/.agents/skills/caveman-commit/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### caveman-compress
- Path: /home/guayaba/.agents/skills/caveman-compress/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### caveman-help
- Path: /home/guayaba/.agents/skills/caveman-help/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### caveman-review
- Path: /home/guayaba/.agents/skills/caveman-review/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### chained-pr
- Path: /home/guayaba/.claude/skills/chained-pr/SKILL.md
...
- Path: /home/guayaba/.claude/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/guayaba/.claude/skills/comment-writer/SKILL.md
...
### go-testing
- Path: /home/guayaba/.claude/skills/go-testing/SKILL.md
...
### issue-creation
- Path: /home/guayaba/.claude/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/guayaba/.claude/skills/judgment-day/SKILL.md
...
### skill-creator
- Path: /home/guayaba/.claude/skills/skill-creator/SKILL.md
...
### work-unit-commits
- Path: /home/guayaba/.claude/skills/work-unit-commits/SKILL.md
