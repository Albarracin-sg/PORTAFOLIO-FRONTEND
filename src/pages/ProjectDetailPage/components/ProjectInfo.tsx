  ...
  return (
    <div className="mb-10 space-y-4">
      ...
      <div className="flex flex-wrap gap-2 text-sm pt-1">
        <div className="inline-flex items-center gap-1.5 bg-zinc-100 dark:bg-white/5 border border-zinc-200 dark:border-white/10 px-3 py-1.5 rounded-xl shrink-0">
        ...
        <div className="inline-flex items-center gap-1.5 bg-zinc-100 dark:bg-white/5 border border-zinc-200 dark:border-white/10 px-3 py-1.5 rounded-xl">
