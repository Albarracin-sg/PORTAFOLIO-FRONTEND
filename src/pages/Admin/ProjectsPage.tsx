...
import { fetchProjects, Project, syncGithubProjects, updateProject } from '@/features/admin/api/projects';
  ...
  return (
    <div className="space-y-6">
            ...
            projects.map((project) => (
              <button
                ...
                className={`w-full text-left flex items-center justify-between border-b border-gray-200/60 pb-2 transition-colors ${
                  selectedProjectId === project.id ? 'text-violet-600' : 'text-gray-900 dark:text-gray-100'
                }`}
              >
                <div>
      ...
      {selectedProject && (
        <Card className="border-gray-200 dark:border-gray-700">
          <CardHeader>
            <CardTitle className="text-gray-900 dark:text-gray-100">Edit project</CardTitle>
          </CardHeader>
