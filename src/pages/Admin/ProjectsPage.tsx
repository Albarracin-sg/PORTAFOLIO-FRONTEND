          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-2 px-3 h-9 rounded-2xl border border-slate-200 dark:border-white/10 bg-white/60 dark:bg-white/[0.04]">
              ...
              <Input
                ...
                className="h-auto w-36 border-none bg-transparent text-xs p-0 focus-visible:ring-0 text-slate-600 dark:text-slate-400"
              />
            </div>
            ...
            <Button
              ...
              onClick={handleSync}
              disabled={syncing}
              className="h-9 rounded-2xl px-4 gap-2 text-sm border-slate-200 dark:border-white/10 hover:border-violet-300 hover:bg-violet-50 dark:hover:border-violet-500/30 dark:hover:bg-violet-900/10 transition-all duration-300 hover:scale-105"
            >
              {syncing ? (
              ...
              <span className="font-medium">{t('admin.projects.sync')}</span>
            </Button>

            <Button
              size="sm"
              className="h-9 rounded-2xl px-4 gap-2 text-sm bg-violet-600 hover:bg-violet-700 shadow-md shadow-violet-500/20 transition-all duration-300 hover:scale-105"
            >
              <Plus className="h-3.5 w-3.5" />
              <span className="font-medium">{t('admin.projects.new')}</span>
            </Button>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-1.5">
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-4 pt-6">
                ...
                >
                  <ChevronLeft className="h-4 w-4" /> {t('admin.projects.pagination.prev')}
                </Button>
                ...
                <Button
                  ...
                  className="h-9 rounded-2xl px-4 gap-1.5 text-sm hover:bg-violet-500/8 hover:text-violet-600 dark:hover:text-violet-400 transition-all duration-200"
                >
                  {t('admin.projects.pagination.next')} <ChevronRight className="h-4 w-4" />
                </Button>
              </div>
            )}
          </div>
