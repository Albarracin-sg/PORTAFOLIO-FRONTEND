            ...
            <CarouselContent className="-ml-4">
              {carouselProjects.map((project) => {
                ...
                return (
                  ...
                  >
                    <Card className="flex h-full cursor-grab active:cursor-grabbing flex-col overflow-hidden rounded-2xl border border-zinc-200/80 bg-white/85 shadow-lg shadow-zinc-200/60 transition-transform duration-300 hover:-translate-y-1 dark:border-white/10 dark:bg-zinc-950/75 dark:shadow-black/20">
